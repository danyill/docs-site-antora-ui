= MuleSoft Documentation Site UI (Sandbox)
// Settings:
:experimental:
:hide-uri-scheme:
// Variables:
:current-release: v0
// Project URIs:
:uri-project: https://github.com/mulesoft/docs-site-antora-ui-sandbox
// External URIs:
...
This project generates the next version of the UI for the MuleSoft documentation site.
...
Next, make sure that you have at least Node 10 installed.

 $ node -v

If this command fails with an error, you don't have Node installed.
If the command doesn't report a Node 10 version or better (e.g., v10.15.3), you don't have a suitable version of Node installed.
...
Now that you have Node 10 installed, you can proceed with installing the Gulp CLI and the project dependencies.
